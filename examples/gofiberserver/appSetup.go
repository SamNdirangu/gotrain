...
import (
	configurations "training/examples/gofiberserver/config"
	middleware "training/examples/gofiberserver/middlewares"
...
func (app *App) registerMiddlewares(config *configurations.Config) {
